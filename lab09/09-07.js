//22. Разработайте приложение (клиент) 09-07 предназначенное 
// для оправки POST-запроса  с вложенным файлом  MyFile.png.
 
const http = require('http');
const fs = require('fs');
const path = require('path');

const filePath = path.join(__dirname, 'files/MyFile.png'); 
